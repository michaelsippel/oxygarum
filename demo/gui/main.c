...
int main(int argc, char **argv) {
  ...
  oxygarum_create_window_part(win, OXYGARUM_WINDOW_TOP_LEFT, uv0, 0.1f, 0.1f);
  oxygarum_create_window_part(win, OXYGARUM_WINDOW_TOP_CENTER, uv1, 1.2f, 0.1f);
  oxygarum_create_window_part(win, OXYGARUM_WINDOW_TOP_RIGHT, uv2, 0.1f, 0.1f);
  oxygarum_create_window_part(win, OXYGARUM_WINDOW_MIDDLE_LEFT, uv3, 0.1f, 0.4f);
  oxygarum_create_window_part(win, OXYGARUM_WINDOW_MIDDLE_CENTER, uv4, 1.2f, 0.4f);
  oxygarum_create_window_part(win, OXYGARUM_WINDOW_MIDDLE_RIGHT, uv5, 0.1f, 0.4f);
  oxygarum_create_window_part(win, OXYGARUM_WINDOW_BOTTOM_LEFT, uv6, 0.1f, 0.1f);
  oxygarum_create_window_part(win, OXYGARUM_WINDOW_BOTTOM_CENTER, uv7, 1.2f, 0.1f);
  oxygarum_create_window_part(win, OXYGARUM_WINDOW_BOTTOM_RIGHT, uv8, 0.1f, 0.1f);
